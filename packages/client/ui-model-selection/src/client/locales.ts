...
export const zh = {
  ...
  'error.staleOption': '模型列表已更新，请重新打开 /model 后再试',
  'error.unavailableSubagent': '已寻址的子智能体会话不支持模型选择',
  'action.reload': '重新加载',
...
export const en = {
  ...
  'error.staleOption': 'The model list changed. Reopen /model and try again.',
  'error.unavailableSubagent': 'Model selection is unavailable for addressed subagent sessions.',
