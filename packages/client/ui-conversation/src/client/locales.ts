...
export const zh = {
  ...
  'workspace.selectionFailed': '工作区选择失败，请重试',
  'workspace.retrySelection': '重试选择工作区',
...
export const en = {
  ...
  'workspace.selectionFailed': 'Workspace selection failed; try again',
  'workspace.retrySelection': 'Retry workspace selection',
